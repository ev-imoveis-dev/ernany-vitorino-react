...
const PropertyList = () => {
  ...
  const filteredImoveis = useMemo(() => {
    return imoveis.filter(item => {
      const matchFinalidade = filters.finalidade === 'Todos' || item.finalidade === filters.finalidade;
          ...
          <aside className="hidden lg:block w-80 space-y-8 sticky top-32 h-fit">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Todos', 'Venda', 'Aluguel'].map(option => (
                      <button
                        key={option}
                        onClick={() => handleFilterChange('finalidade', option)}
                        className={cn(
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Todos', '1', '2', '3', '4+'].map(option => (
                      <button
                        key={option}
                        onClick={() => handleFilterChange('quartos', option)}
                        className={cn(
                ...
                {/* Reset */}
                <button
                  onClick={() => setFilters({ finalidade: 'Todos', tipo: 'Todos', bairro: '', quartos: 'Todos', ordem: 'recentes' })}
